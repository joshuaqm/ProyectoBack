          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="{{ asset('assets/logo.png') }}" class="img-fluid px-3 px-sm-4 mt-3 mb-4"
                ...
                <form action="{{route('register')}}" method="post">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    <a href="{{route('login')}}" class="btn btn-outline-danger">Volver a login</a>
                  </div>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">Registro en YoshiApp.</h4>
                <p class="small mb-0">Navega, descubre, explora.</p>
              </div>
            </div>
          </div>
        </div>
